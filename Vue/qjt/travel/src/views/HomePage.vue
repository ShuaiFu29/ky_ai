<template>
  <div class="home">
    ...
    <van-search v-model="searchField" placehoder="请输入搜索关键词" show-action shape="round" background="transparent"
      class="mb-2">
      <template #action>
    ...
    <main class="flex flex-col space-y-4">
      ...
      rounded-2xl p-2 shadow-md self-center">
        <section class="topbar flex justify-around mb-3">
          <div v-for="item in topBarState" :key="item.title" class="topbar-item flex flex-col items-center">
